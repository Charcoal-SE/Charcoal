      ...
      <div id="newusermodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;"><div class="modal-dialog"><div class="modal-content">
        ...
        <?php
          ...
          while ($row = mysql_fetch_array($query))
          {
            ...
            echo "<span><h4 class='comment-text text-info" . $row["Id"] . "'>" . (($row['ischarcoalmod'] == 1) ? $row["username"] . " &diams;" : (($row['isnetworkmod']==1) ? $row["username"] . " &#9826;" : $row['username'])) . " </a><span class='small'> - <strong>user" . $row["id"] ."</strong></span></br><span class='small'><strong> " . $handled["number"] . " </strong> flags handled total</span></h4>";
            echo "</div>";
