<?php
	...
	foreach ($commentsToInspect as $valid){
              ...
              mysql_query("UPDATE flags SET handled=1, handleDate='$timestamp', wasValid=1, lastCronCheck='$timestamp', wasObsolete=1, handledBy=0 WHERE `Id`=" . $valid. " AND  `site`='" . $siteTableName  . "'");
        }
